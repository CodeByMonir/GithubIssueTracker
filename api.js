...
function displayData(data) {
    ...
    data.forEach((data) => {
        ...
        card.setAttribute("onclick", `loadModal(${data.id})`);
...
function modal(data){
    ...
    modalContainer.innerHTML = `
        ...
        <div class="modal-box">
            ...
            <div class="flex items-center gap-2 text-[12px] text-[#64748B] mb-4">
                <button class="${data.status === "open" ? "bg-[#00A96E]" : "bg-[#A855F7]"} py-1 px-2 outline-none rounded-full -2 text-white">${data.status}</button> 
